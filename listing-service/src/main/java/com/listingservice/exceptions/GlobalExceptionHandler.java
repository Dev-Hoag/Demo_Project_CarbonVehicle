...
import com.listingservice.dtos.responses.ErrorResponse;
import com.listingservice.dtos.responses.ValidationErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleInvalidBid(
        ...
        log.error("Invalid bid: {}", ex.getMessage());
    ...
    public ResponseEntity<ErrorResponse> handleInvalidListing(
    ...
    public ResponseEntity<ErrorResponse> handleAuctionEnded(
        ...
        log.error("Auction ended: {}", ex.getMessage());
    ...
    public ResponseEntity<ErrorResponse> handleInvalidListingState(
            InvalidListingStateException ex,
            HttpServletRequest request) {

        log.error("Invalid listing state: {}", ex.getMessage());
