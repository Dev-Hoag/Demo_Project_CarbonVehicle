...
export class KycManagementService {
  ...
  async verifyDocument(
    ...
    try {
      console.log('[KYC] Calling User Service:', {
        url: `${this.userServiceUrl}/internal/kyc/documents/${docId}/verify`,
        dto,
        adminId,
      });
      ...
      console.log('[KYC] User Service response:', response.status, response.data);
      return response.data;
    } catch (error: any) {
      console.error('[KYC] Error calling User Service:', {
